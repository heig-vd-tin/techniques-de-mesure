...
L'abréviation de « Système International » est SI, \textbf{quelle que soit la langue utilisée}\footnote{oui, \textit{même} en anglais}. La norme internationale ISO 1000 (ICS 01 060) décrit les unités SI et les recommandations pour l'emploi de leurs multiples et de certaines autres unités.
...
\\ \hline
masse & kilogramme & kg & 
Le kilogramme \textbf{était} défini, depuis le 10 décembre 1799 et jusqu'au 20 mai 2019, comme la masse d'un cylindre composé d'un alliage de platine (90 \%) et d'iridium (10\%), conservé au Bureau International des Poids et Mesures. A présent, il est déterminé à partir d'une des constantes fondamentales de la physique, la \textbf{constante de Planck} $h$, qui est la constante de proportionnalité entre l'énergie d'un photon et sa fréquence d'oscillation; la page wikipédia de la définition du kilogramme décrit la procédure, très complexe, permettant de passer de la constante $h$ à la détermination de la masse d'un objet.
\\ \hline
temps & seconde & s &
...
\begin{center}
\begin{tabular}[t]{>{\pbs\raggedright}p{3cm}
                    >{\pbs\centering}p{1.6cm}
                    >{\pbs\centering}p{1.0cm}
                    >{\pbs\centering}p{1.8cm}
                    >{\pbs\centering}p{2.3cm}
                    >{\pbs\raggedright}p{3.5cm}}
\hline\hline
\textbf{Grandeur} & \textbf{Nom} & \textbf{Sym. SI} & \textbf{lien avec autres unités} & \textbf{lien avec unités de base} & \textbf{Relation}\\
\hline
...
%\footnotesize
\begin{center}
\begin{tabular}{>{\pbs\raggedright}p{0.8cm}>{\pbs\raggedright}p{1.4cm}>{\pbs\centering}p{1.5cm}ll}
...
\begin{wrapfigure}[20]{l}[0pt]{5cm}
   \centering
   \includegraphics[width=5cm]{fig/defAngleSolide.pdf} 
...
Les grandeurs « angle plan » et « angle solide » sont des unités sans dimension - puisqu'il s'agit de rapport de longueurs et de surface - qui peuvent être indiquées ou non dans les expressions des unités dérivées.
